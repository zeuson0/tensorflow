...
absl::Status ConvertMLIRToTFLiteFlatBuffer(
  ...
  if (converter_flags.has_dump_graphviz_dir()) {
    TF_RETURN_IF_ERROR(DumpOpGraphToFile(
        module.get(),
        // rename once we enable the new converter feature flag.
        absl::StrCat(converter_flags.dump_graphviz_dir(),
                     "/toco_AT_IMPORT.dot")));
  }
  ...
  auto status = ConvertTFExecutorToTFLOrFlatbuffer(
      module.get(), /*export_to_mlir=*/false, converter_flags, pass_config_copy,
  ...
  if (converter_flags.has_dump_graphviz_dir()) {
    TF_RETURN_IF_ERROR(DumpOpGraphToFile(
        // rename once we enable the new converter feature flag.
        module.get(), absl::StrCat(converter_flags.dump_graphviz_dir(),
